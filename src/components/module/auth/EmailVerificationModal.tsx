...
const EmailVerificationModal = (
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
            <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-[#060f0a] border border-primary/25 shadow-[0_0_60px_hsl(217_91%_60%/0.2)]">
                ...
                <div className="p-7">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="flex-1 relative p-[2px] rounded-xl overflow-hidden">
                                <span className="absolute inset-[-100%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_60%,rgba(255,255,255,0.8)_100%)]" />
                                <button onClick={onClose}
                                    className="relative w-full bg-primary hover:bg-blue-600 transition-colors duration-300 text-white font-bold py-2.5 rounded-[10px] text-sm shadow-md">
                                    লগইন করুন
                                </button>
                            </div>
                        </div>
