...
const featureCards = [
    {
        ...
        description: "Learn to speak English confidently in real-life conversations and interviews.",
    },
    {
        icon: <FaGlobeAmericas className="h-5 w-5" />,
        title: "IELTS Preparation",
        description: "Follow our expert guidelines to achieve the score you need for higher education and career growth.",
    },
    {
        icon: <FaBookOpen className="h-5 w-5" />,
        title: "Advanced Grammar",
        description: "Master correct pronunciation, vocabulary, and corporate-level grammar skills easily.",
    },
];
...
export default function EnglishSkills() {
    const skills = [
        { icon: <FaMicrophoneAlt />, name: "Spoken" },
        { icon: <FaPencilAlt />, name: "Writing" },
    ];
    ...
    return (
        <section className="relative overflow-hidden bg-[#040a07] py-24 selection:bg-blue-400/30 selection:text-white md:py-32">
            ...
            <div className="pointer-events-none absolute left-1/2 top-0 h-[300px] w-[600px] -translate-x-1/2 rounded-[100%] bg-blue-500/[0.04] blur-[120px]" />
                ...
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <div className="relative w-full max-w-4xl mx-auto flex flex-col items-center justify-center">
                        ...
                        <FadeIn delay={0.2} direction="up" className="relative z-30 w-full pointer-events-none">
                            <h2 className="mb-6 text-4xl font-semibold tracking-tight text-white md:text-5xl lg:text-7xl lg:leading-[1.1] pointer-events-auto drop-shadow-lg">
                                Your{" "}
                                <span className="bg-gradient-to-br from-white via-blue-400 to-blue-700 bg-clip-text text-transparent">
                                    English Skills
                                </span>
                            </h2>
                        </FadeIn>
                    ...
                    <FadeIn delay={0.3} direction="up" className="relative z-10">
                        <p className="mx-auto mb-12 max-w-xl text-base leading-relaxed text-zinc-400/80 md:text-lg hover:text-white/80 transition-colors">
                            Prepare yourself for spoken English, IELTS, and corporate communication to keep up with the world.
                        </p>
                    </FadeIn>
                    ...
                    <FadeIn delay={0.5} direction="up">
                        <div className="mb-14 flex w-full max-w-[800px] items-center gap-4 opacity-70">
                            ...
                            <span className="text-[10px] font-medium uppercase tracking-[0.3em] text-blue-400/60">What You Will Learn</span>
                            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-blue-400/20 to-transparent" />
                        </div>
                    </FadeIn>
                </div>
