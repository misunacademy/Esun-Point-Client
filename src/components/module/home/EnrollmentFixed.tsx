      ...
      "
            ...
            >
                <button
                    ...
                    className="absolute -top-2 -right-2 grid h-6 w-6 place-items-center rounded-full border border-blue-200/50 bg-[#0b1d3a] text-blue-100 shadow-md transition hover:scale-105 hover:text-white"
                >
                    <X size={14} />
                </button>
