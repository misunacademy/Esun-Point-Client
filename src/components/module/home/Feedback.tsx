                ...
                <FadeIn delay={index * 0.1} direction="up" className="h-full">
                  <div className="relative p-[2px] rounded-xl overflow-hidden group transition-all duration-500 hover:-translate-y-1">
                    ...
                    <span
                      ...
                      style={{
                        background:
                          'conic-gradient(from 0deg, transparent 0%, transparent 30%, hsl(217 91% 60% / 0.5) 44%, hsl(156 80% 65%) 52%, hsl(217 91% 60% / 0.4) 60%, transparent 75%)',
                      }}
                    />
        ...
        <Link href="/feedback">
          ...
          <div className="relative p-[2px] rounded-xl overflow-hidden group">
            ...
            <span
              ...
              style={{
                background:
                  'conic-gradient(from 90deg, transparent 20%, hsl(217 91% 60%) 45%, hsl(217 85% 75%) 55%, hsl(217 91% 60%) 70%, transparent 80%)',
              }}
            />
            <button
              className="relative z-10 px-10 py-3.5 rounded-[10px] text-sm md:text-base font-bold text-white
                bg-gradient-to-r from-blue-800 via-primary to-blue-700
