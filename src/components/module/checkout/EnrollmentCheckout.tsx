...
// import { useEnrollStudentManualMutation } from "@/redux/features/student/studentApi";
                                        ...
                                        <>
                                            ...
                                            <div className="flex justify-between items-center text-lg font-semibold">
                                                ...
                                                <span className="text-primary font-bold">
                                                    {/* TK{(featuredBatchId.price || 0)} */}
                                                    ৳{(featuredBatchId?.price?.toLocaleString('en-IN') || 0)}
                                                </span>
                                            </div>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className={`relative p-[1.5px] rounded-xl overflow-hidden transition-opacity ${!(form.formState.isValid && agreed && isEnrollmentOpen) || isProcessing ? 'opacity-50' : ''}`}>
                                                        ...
                                                        <button
                                                            ...
                                                            className="relative w-full bg-gradient-to-r bg-primary hover:bg-blue-600 disabled:cursor-not-allowed transition-colors duration-300 text-white font-bold py-3.5 rounded-xl text-base shadow-md"
                                                        >
                                                            {isProcessing ? (
