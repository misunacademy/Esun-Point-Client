                        ...
                        <ol className="space-y-2.5">
                            {dynamicInstructions.map((instruction, index) => (
                                <li key={index} className="flex items-start gap-3">
                                    ...
                                    <span className="text-sm text-white/55 leading-relaxed">{instruction.includes("EP")?`Add reference: 'EP-${batch}'`:instruction}</span>
                                </li>
                            ))}
                        </ol>
                    </div>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input
                                                ...
                                                {...field}
                                                className={cn(
                                                    "h-12 bg-[#0b1220] border-blue-500/25 text-white placeholder:text-white/30 focus:border-blue-500/55 focus-visible:ring-blue-500/40 autofill:shadow-[inset_0_0_0px_1000px_rgb(11,18,32)] autofill:[-webkit-text-fill-color:white]",
                                                    fieldState.invalid
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input
                                                ...
                                                {...field}
                                                className={cn(
                                                    "h-12 font-mono bg-[#0b1220] border-blue-500/25 text-white placeholder:text-white/30 focus:border-blue-500/55 focus-visible:ring-blue-500/40 autofill:shadow-[inset_0_0_0px_1000px_rgb(11,18,32)] autofill:[-webkit-text-fill-color:white]",
                                                    fieldState.invalid
                                                        ? "border-red-500/60 focus-visible:ring-red-500/30"
                                                        : fieldState.isTouched && field.value
                                                            ? "border-primary/50"
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <div className={`flex-1 relative p-[1.5px] rounded-xl overflow-hidden ${!form.formState.isValid ? 'opacity-50' : ''
                                    }`}>
