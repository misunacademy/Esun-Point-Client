...
export function ChatToggleButton({ isOpen, showNotification, onClick }: ChatToggleButtonProps) {
  return (
    <button
      onClick={onClick}
    ...
    >
      ...
      {showNotification && !isOpen && (
        <span className="absolute -top-1 -right-1 z-20 flex h-5 w-5">
          ...
          <span className="relative inline-flex rounded-full h-5 w-5 bg-primary text-[9px] font-bold text-white items-center justify-center">1</span>
        </span>
      )}
