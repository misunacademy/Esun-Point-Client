			...
			<div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center justify-center gap-8 px-6 py-20 text-center">
				...
				<div className="flex justify-center mb-2">
					<div className="relative p-[1.5px] rounded-full overflow-hidden">
						...
						<span className="absolute inset-[-100%] animate-[spin_6s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_40%,hsl(217_91%_60%)_70%,hsl(217_91%_60%)_100%)] opacity-70" />
				...
				<div className="relative p-[1.5px] rounded-2xl overflow-hidden shadow-[0_0_40px_hsl(217_91%_60%/0.15)]">
					{/* Rotating conic border */}
					<span className="absolute inset-[-100%] animate-[spin_8s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_60%,hsl(217_91%_60%/0.8)_100%)]" />
