  ...
  return (
    <div className="min-h-screen bg-[#060f0a] flex items-center justify-center px-4">
      <div className="max-w-md text-center space-y-6">
        ...
        <h1 className="text-2xl font-bold text-white/90">Payment Error</h1>
        <p className="text-white/50">Something went wrong during payment processing. Please try again.</p>
